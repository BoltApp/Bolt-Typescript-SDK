...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.jsonErr("4XX", errors.AccountPaymentMethodDeleteResponseBody$inboundSchema),
        m$.fail("5XX"),
        m$.nil([200, "default"], operations.AccountPaymentMethodDeleteResponse$inboundSchema)
