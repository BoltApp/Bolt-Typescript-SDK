...
> = z.object({
  ...
  "account-test-creation-data":
    components.AccountTestCreationData$inboundSchema,
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  "account-test-creation-data": components
    .AccountTestCreationDataOutput$inboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  accountTestCreationData: components
    .AccountTestCreationDataOutput$outboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
    contentType: "ContentType",
    statusCode: "StatusCode",
