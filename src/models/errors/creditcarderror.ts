...
export namespace SchemasCreditCardErrorTag$ {
    export const inboundSchema: z.ZodNativeEnum<typeof SchemasCreditCardErrorTag> =
        z.nativeEnum(SchemasCreditCardErrorTag);
    export const outboundSchema: z.ZodNativeEnum<typeof SchemasCreditCardErrorTag> = inboundSchema;
}
