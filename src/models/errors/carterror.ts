...
export namespace SchemasCartErrorTag$ {
    export const inboundSchema: z.ZodNativeEnum<typeof SchemasCartErrorTag> =
        z.nativeEnum(SchemasCartErrorTag);
    export const outboundSchema: z.ZodNativeEnum<typeof SchemasCartErrorTag> = inboundSchema;
}
