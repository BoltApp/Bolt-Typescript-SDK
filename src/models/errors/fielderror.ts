...
export namespace SchemasTag$ {
    export const inboundSchema: z.ZodNativeEnum<typeof SchemasTag> = z.nativeEnum(SchemasTag);
    export const outboundSchema: z.ZodNativeEnum<typeof SchemasTag> = inboundSchema;
}
