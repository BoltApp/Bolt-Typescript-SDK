...
export namespace PaymentMethodReferenceTag$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PaymentMethodReferenceTag> =
        z.nativeEnum(PaymentMethodReferenceTag);
    export const outboundSchema: z.ZodNativeEnum<typeof PaymentMethodReferenceTag> = inboundSchema;
}
