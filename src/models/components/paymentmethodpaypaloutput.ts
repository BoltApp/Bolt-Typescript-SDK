...
export namespace PaymentMethodPaypalTag$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PaymentMethodPaypalTag> =
        z.nativeEnum(PaymentMethodPaypalTag);
    export const outboundSchema: z.ZodNativeEnum<typeof PaymentMethodPaypalTag> = inboundSchema;
}
