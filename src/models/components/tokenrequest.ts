...
/** @internal */
export const TokenRequest$inboundSchema: z.ZodType<TokenRequest, z.ZodTypeDef, unknown> = z.union([
    AuthorizationCodeRequest$inboundSchema,
    RefreshTokenRequest$inboundSchema,
]);
...
export const TokenRequest$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    TokenRequest
> = z.union([AuthorizationCodeRequest$outboundSchema, RefreshTokenRequest$outboundSchema]);
