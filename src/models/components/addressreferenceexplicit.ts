 ...
 */
export enum AddressReferenceExplicitCountryCode {
    Af = "AF",
    Ax = "AX",
    Al = "AL",
    Dz = "DZ",
...
export type AddressReferenceExplicit = {
     ...
     * The country (in its ISO 3166 alpha-2 format) associated with this address.
     */
    countryCode: AddressReferenceExplicitCountryCode;
    /**
...
/** @internal */
export const AddressReferenceExplicitCountryCode$ = z.nativeEnum(
    AddressReferenceExplicitCountryCode
);
...
export namespace AddressReferenceExplicit$ {
    export type Inbound = {
        ...
        postal_code: string;
        region?: string | undefined;
        country_code: AddressReferenceExplicitCountryCode;
        email?: string | undefined;
        phone?: string | undefined;
    };
