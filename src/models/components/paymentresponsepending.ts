...
export namespace PaymentResponsePendingTag$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PaymentResponsePendingTag> =
        z.nativeEnum(PaymentResponsePendingTag);
    export const outboundSchema: z.ZodNativeEnum<typeof PaymentResponsePendingTag> = inboundSchema;
}

/** @internal */
export namespace PaymentResponsePendingStatus$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PaymentResponsePendingStatus> = z.nativeEnum(
        PaymentResponsePendingStatus
    );
    export const outboundSchema: z.ZodNativeEnum<typeof PaymentResponsePendingStatus> =
        inboundSchema;
}
