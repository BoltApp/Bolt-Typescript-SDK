...
import {
  ...
  PaymentMethodReference$inboundSchema,
  PaymentMethodReference$Outbound,
  PaymentMethodReference$outboundSchema,
  PaymentMethodReferenceTag,
} from "./paymentmethodreference.js";
...
/** @internal */
export const PaymentMethodExtended$inboundSchema: z.ZodType<
  PaymentMethodExtended,
  z.ZodTypeDef,
  unknown
> = z.union([
  PaymentMethodReference$inboundSchema.and(
    z.object({ ".tag": z.literal(PaymentMethodReferenceTag.Id) }).transform((
      v,
    ) => ({ dotTag: v[".tag"] })),
  ),
...
/** @internal */
export type PaymentMethodExtended$Outbound =
...
/** @internal */
export const PaymentMethodExtended$outboundSchema: z.ZodType<
  PaymentMethodExtended$Outbound,
  z.ZodTypeDef,
  PaymentMethodExtended
> = z.union([
  PaymentMethodReference$outboundSchema.and(
    z.object({ dotTag: z.literal(PaymentMethodReferenceTag.Id) }).transform((
      v,
    ) => ({ ".tag": v.dotTag })),
  ),
...
export namespace PaymentMethodExtended$ {
  /** @deprecated use `PaymentMethodExtended$inboundSchema` instead. */
  export const inboundSchema = PaymentMethodExtended$inboundSchema;
  /** @deprecated use `PaymentMethodExtended$outboundSchema` instead. */
  export const outboundSchema = PaymentMethodExtended$outboundSchema;
  /** @deprecated use `PaymentMethodExtended$Outbound` instead. */
  export type Outbound = PaymentMethodExtended$Outbound;
}

export function paymentMethodExtendedToJSON(
  paymentMethodExtended: PaymentMethodExtended,
): string {
  return JSON.stringify(
    PaymentMethodExtended$outboundSchema.parse(paymentMethodExtended),
  );
}

export function paymentMethodExtendedFromJSON(
  jsonString: string,
): SafeParseResult<PaymentMethodExtended, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PaymentMethodExtended$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PaymentMethodExtended' from JSON`,
  );
}
