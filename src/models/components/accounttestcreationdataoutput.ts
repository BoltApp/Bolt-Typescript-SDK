...
/** @internal */
export const EmailState$inboundSchema: z.ZodNativeEnum<typeof EmailState> =
    z.nativeEnum(EmailState);
...
/** @internal */
export const PhoneState$inboundSchema: z.ZodNativeEnum<typeof PhoneState> =
    z.nativeEnum(PhoneState);
