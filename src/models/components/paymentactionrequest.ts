...
export namespace PaymentActionRequestTag$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PaymentActionRequestTag> =
        z.nativeEnum(PaymentActionRequestTag);
    export const outboundSchema: z.ZodNativeEnum<typeof PaymentActionRequestTag> = inboundSchema;
}
