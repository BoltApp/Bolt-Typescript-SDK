...
export namespace GrantType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GrantType> = z.nativeEnum(GrantType);
    export const outboundSchema: z.ZodNativeEnum<typeof GrantType> = inboundSchema;
}
